        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Tambah Denda</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('denda.store') }}" method="POST" id="dendaForm">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('jumlah_denda_perhari') is-invalid @enderror" id="jumlah_denda_perhari" name="jumlah_denda_perhari" value="{{ old('jumlah_denda_perhari', 1000) }}" required>
                        ...
                        <div class="mb-3">
                            <label for="jumlah_hari_terlambat" class="form-label">Jumlah Hari Terlambat</label>
                            <input type="number" class="form-control" id="jumlah_hari_terlambat" readonly>
                        </div>
                        
                        <div class="mb-3">
                            <label for="total_denda_keseluruhan" class="form-label">Total Denda Keseluruhan (Rp)</label>
                            <input type="number" class="form-control @error('total_denda_keseluruhan') is-invalid @enderror" id="total_denda_keseluruhan" name="total_denda_keseluruhan" value="{{ old('total_denda_keseluruhan', 0) }}" required>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="button" id="hitungDenda" class="btn btn-info">Hitung Denda</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('hitungDenda').addEventListener('click', function() {
            ...
            .then(data => {
                document.getElementById('jumlah_hari_terlambat').value = data.jumlah_hari_terlambat;
