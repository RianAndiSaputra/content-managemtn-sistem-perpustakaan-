        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Tambah Petugas Perpustakaan</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('petugas.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('username_petugas') is-invalid @enderror" id="username_petugas" name="username_petugas" value="{{ old('username_petugas') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control @error('password_petugas') is-invalid @enderror" id="password_petugas" name="password_petugas" required>
